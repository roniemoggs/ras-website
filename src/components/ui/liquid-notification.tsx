...
export const LiquidGlassCard = ({
            ...
            ? {
                ...
                animate: expandable
                    ? isExpanded
                        ...
                        : 'collapsed'
                    : undefined,
                onClick: expandable && !expandOnHover ? handleToggleExpansion : undefined,
                onHoverStart: expandable && expandOnHover ? () => setIsExpanded(true) : undefined,
                onHoverEnd: expandable && expandOnHover ? () => setIsExpanded(false) : undefined,
                drag: draggable,
                ...
                whileHover: { scale: expandable ? (isExpanded ? 1 : 1.01) : 1.01 },
                whileTap: { scale: 0.98 },
            }
            : {};
    ...
    return (
        <>
            ...
            <MotionComponent
                className={cn(
                    `relative ${draggable ? 'cursor-grab active:cursor-grabbing' : ''} ${expandable ? 'cursor-pointer' : ''} flex flex-col justify-center`,
                    className
                )}
                style={{
                    borderRadius,
            ...
            >
                ...
                {/* Content */}
                <div className={cn('relative z-30 w-full h-full flex flex-col', className ? '' : 'p-4 md:p-6')}>
